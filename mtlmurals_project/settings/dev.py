"""
    Development Django settings for the mtlmurals project
    =====================================================
...
TEMPLATES[0]['OPTIONS']['context_processors'] += (  # noqa: F405
    'mtlmurals_project.context_processors.webpack', )
...
STATICFILES_DIRS = (
    str(PROJECT_PATH / 'mtlmurals' / 'static' / 'build_dev'),  # noqa: F405
    str(PROJECT_PATH / 'mtlmurals' / 'static' / 'build'),  # noqa: F405
    str(PROJECT_PATH / 'mtlmurals' / 'static'),  # noqa: F405
)
